	...
	<div id="wrap">
		...
		<main id="main">
			<div id="adManu">
				<ul>
					<li><a href="#">회원관리</a></li>
					<li><a href="/Proj_OnedayClass/levelUp/LvlUpList.jsp">등업관리</a></li>
					<li><a href="/Proj_OnedayClass/classbbs/ClassList.jsp" >클래스 게시판</a></li>
					<li id="adMainLi" class="mainAdMenu" >
						<a href="#">게시판관리</a>
					 	<div id="subAdMenu" class="subContainer">
                            <ul class="subAdMenu2 flex-container">
                                <li class="subAdMenuLi"><a href="/Proj_OnedayClass/classbbs/ClassList.jsp" id="">클래스 게시판</a></li>
