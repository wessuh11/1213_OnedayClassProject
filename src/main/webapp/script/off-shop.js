...
$(function(){
    ...
    for (let i = 0; i < contentArray3.length; i++) {
        ...
        for (let j = 0; j < contentArray3[i].length; j++) {
            ...
            if (j == 0) {
                galleryListArea3 += "<td><a href='off-shop-detail.html'><img src='../images/"+ contentArray3[i][j] +"' alt='이미지' width='320'></a></td>";
            } else if (j == 1) {
...
for (let i = 0; i < contentArray4.length; i++) {
    ...
    for (let j = 0; j < contentArray4[i].length; j++) {
        ...
        if (j == 0) {
            galleryListArea4 += "<td><a href='off-shop-detail.html'><img src='../images/"+ contentArray4[i][j] +"' alt='이미지' width='320'></a></td>";
        } else if (j == 1) {
