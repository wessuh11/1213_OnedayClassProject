...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="/Proj_OnedayClass/style/off-shop.css">
</head>
<body>
	...
	<div id="wrap">
        ...
        <nav id="gnb">
            <ul class="flex-container">
                ...
                <li class="active"><a href="/Proj_OnedayClass/shop/off-shop.jsp">Offline</a></li>
...
<% } %>
    ...
    <script src="/Proj_OnedayClass/script/off-shop.js"></script>
</body>
</html>